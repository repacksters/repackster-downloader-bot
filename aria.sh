...
wget https://github.com/CypherpunkSamurai/TARclonef/raw/master/aria2-1.35.0-static-linux-amd64_patch_P3TERX.tar.gz
tar xf aria2-1.35.0-static-linux-amd64_patch_P3TERX.tar.gz
rm aria2-1.35.0-static-linux-amd64_patch_P3TERX.tar.gz
chmod 755 aria2c
